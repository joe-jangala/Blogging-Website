...
import {SignupInput} from "@joe_jangala/medium-blog"
...
export const Auth = ({type}:{type: "signup"|"signin"}) =>{
    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        <div className="flex justify-center">
            ...
            <div className="pt-8">
                {type === "signup"?
            <LabelledInput label="Name" placeholder="Joe Jangala" onChange={(e)=>{
                setpostInputs(c=>({
                    ...c,
                    //@ts-ignore
                    name: e.target.value
            ...
            <LabelledInput label="Username" placeholder="joe@gmail.com" onChange={(e)=>{
                setpostInputs(c=>({
                    ...c,
                    //@ts-ignore
...
function LabelledInput({label,placeholder,onChange,type}:LabelledInputType){
    return <div>
    <label className="block mb-2 text-sm font-bold text-gray-900 dark:text-black pt-4">{label}</label>
